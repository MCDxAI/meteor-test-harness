...
dependencies {
    ...
    // Fabric API (needed for client-side mod, also a transitive runtime dep of owo).
    // MC 26.x is unobfuscated so no modImplementation remap shim is needed.
    implementation(libs.fabricApi)

    // owo-lib — present at compile time + dev runtime; in production the user supplies it.
    compileOnly(libs.owoLib)
